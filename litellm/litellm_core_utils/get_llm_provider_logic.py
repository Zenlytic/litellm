    ...
    try:
        ...
        if not custom_llm_provider:
            if litellm.suppress_debug_info is False:
                print()  # noqa
                print("\033[1;31mProvider List: https://docs.litellm.ai/docs/providers\033[0m")  # noqa  # noqa  # noqa
                print()  # noqa
...
def _get_openai_compatible_provider_info(  # noqa: PLR0915
    ...
    if custom_llm_provider == "perplexity":
        ...
        api_base = (
            api_base or get_secret("VOLCENGINE_API_BASE") or "https://ark.cn-beijing.volces.com/api/v3"
        )  # type: ignore
